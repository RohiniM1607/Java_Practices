/*
 * The E2_FileExtension class demonstrates a program
 * that retrieves files with a specific extension
...
public class E2_FileExtension {
	...
	public static void main(String[] args) {
		...
		try {
			File folder = new File("D:\\EXPLEO - SmartCliff_Training\\Git\\Git and GitHub with eclipse\\JavaPractices\\HandsOn"); 
